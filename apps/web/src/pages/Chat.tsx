            ...
            <div className='grow text-end space-y-3'>
              <div className='inline-block bg-blue-600 rounded-lg p-4 shadow-2xs'>
                ...
                <div className='mt-3'>
                  <button
                    type='button'
                    className='p-2 inline-flex justify-center items-center gap-x-1 rounded-lg bg-white/10 border border-transparent font-medium text-gray-100 hover:text-gray-600 hover:bg-white focus:outline-hidden focus:ring-2 ring-offset-blue-600 focus:ring-white focus:ring-offset-2 text-xs'
                  >
                    <svg
                      className='shrink-0 size-4'
                      xmlns='http://www.w3.org/2000/svg'
          ...
          <li className='max-w-2xl ms-auto flex justify-end gap-x-2 sm:gap-x-4'>
            <div>
              <div className='text-end'>
                <button
                  type='button'
                  className='mb-2.5 ms-1.5 mb-1.5 py-2 px-3 inline-flex justify-center items-center gap-x-2 rounded-lg border border-blue-600 bg-white text-blue-600 align-middle hover:bg-blue-50 focus:outline-hidden focus:bg-blue-50 text-sm dark:bg-neutral-900 dark:text-blue-500 dark:border-blue-500 dark:hover:text-blue-400 dark:hover:border-blue-400 dark:focus:text-blue-400 dark:focus:border-blue-400'
                >
